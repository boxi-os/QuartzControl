...
const SEITEN = [
  ...
  { de: 'gestaltung/ueber-dem-inhalt/titel-und-datum', en: 'en/design/above-the-content/title-and-date', files: ['meta-article-title.scss', 'meta-content-meta.scss'] },
  ...
  { de: 'gestaltung/seitentypen/ordner-und-tags', en: 'en/design/page-types/folders-and-tags', files: ['page-folder.scss', 'page-tag.scss'] },
