export default {
  ...
  home: {
    ...
    wizard: {
      ...
      useTemplate: 'Install the basic template',
      useTemplateHint:
      ...
      templateContentHint:
        'Twenty short pages in two languages that show what the site looks like before you have notes of your own. They are meant to be deleted; leave them out if you bring your own notes.',
  ...
  layoutEditor: {
    ...
    excludeDeadHint_one: 'The file still holds the exclusion “{{names}}” from an earlier version. It has no effect and disappears once you change something about this page type and save.',
    excludeDeadHint_other: 'The file still holds {{count}} exclusions from an earlier version ({{names}}). They have no effect and disappear once you change something about this page type and save.',
    template: 'Frame',
  ...
  styles: {
    ...
    variables: {
      ...
      light: 'Light',
      dark: 'Dark',
      bothModes: 'Light and dark',
      splitDark: 'Different in dark mode',
  ...
  styleEditor: {
    ...
    current: {
      ...
      fontsNoRule:
        'No @font-face rule in the project names: {{families}}. Visitors only see them if they are installed on their own machine — otherwise import the file below, or pick Google Fonts as the font source.',
  ...
  templates: {
    ...
    planInvalidFrameDetail: 'Skipped: {{detail}}',
    planInvalidFramesMore: 'and {{count}} more frame',
    planInvalidFramesMore_other: 'and {{count}} more frames',
    quotedName: '“{{value}}”',
  ...
  dnd: {
    ...
    pickedOver: '{{name}} picked up, over {{target}}.',
