...
export default async function beforePack(context) {
  ...
  // Das Benutzerhandbuch reist seit dem 2026-09-18 nicht mehr mit - es wird nur online gepflegt
  // (HANDBOOK_URL in electron/main/menu.ts). Bis dahin baute dieser Haken es hier nach
  // resources/handbook und brach ab, wenn das nicht ging.
}
