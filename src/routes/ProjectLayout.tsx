      ...
      <aside className="flex w-60 shrink-0 flex-col border-r border-ink/[0.06] bg-ink/[0.02] dark:border-ink/10 dark:bg-ink/[0.03]">
        ...
        <div className="px-2 pb-2">
          <NavLink
            ...
            className="titlebar-no-drag flex items-center gap-1.5 rounded-[6px] px-2.5 py-1.5 text-ui font-medium text-slate-700 transition-colors hover:bg-ink/[0.05] dark:text-slate-200 dark:hover:bg-ink/10"
          >
